...
namespace SqlExplorer.MsSqlServer
{
    ...
    public class ForeignKey : DbBase, IEquatable<ForeignKey>
    {
        ...
        {
            int hashCode = -1202017820;
            hashCode = hashCode * -1521134295 + base.GetHashCode();
            hashCode = hashCode * -1521134295 + EqualityComparer<Table>.Default.GetHashCode(ParentTable);
            hashCode = hashCode * -1521134295 + EqualityComparer<Table>.Default.GetHashCode(ChildTable);
            hashCode = hashCode * -1521134295 + EqualityComparer<string>.Default.GetHashCode(ChildColumnName);
            hashCode = hashCode * -1521134295 + EqualityComparer<string>.Default.GetHashCode(ParentColumnName);
            return hashCode;
        }
    }
}
